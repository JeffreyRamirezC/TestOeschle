...
import com.tvs.maintenance.util.ui.barcode.camera.CameraSource;
import com.tvs.maintenance.util.ui.barcode.camera.CameraSourcePreview;
import com.tvs.maintenance.util.ui.barcode.camera.GraphicOverlay;
...
public class BarcodeReaderFragment extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView tv=view.findViewById(R.id.title_scan);
            ...
            if (Build.VERSION.SDK_INT>=23&&shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)) {
                ...
                builder.setPositiveButton(R.string.grant, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        intent.setData(uri);
                        //DataBase.hideKeyboard(getActivity(),);
