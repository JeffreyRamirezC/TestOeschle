package com.tvs.maintenance.util;
...
public class RequestPermissionHandler {
    ...
    public static RequestPermissionHandler sInstance;
    public static RequestPermissionHandler getInstance(){
        if(sInstance==null){
            sInstance=new RequestPermissionHandler();
        }
        return sInstance;
    }
